...
const About = () => {
    return (
        <div className="hero min-h-screen pb-10 bg-base-200">
            <div className="hero-content flex-col lg:flex-row">
                <div className='lg:w-1/2 relative'>
                    <img src={person} className="w-3/4 rounded-lg shadow-2xl" />
                    <img src={parts} className="w-1/2 right-5 top-1/2 absolute rounded-lg border-8 border-white shadow-2xl" />
                </div>
                <div className='lg:w-1/2 space-y-5 p-5'>
                    ...
                    <button className="p-2 pl-4 pr-4 rounded-md text-white bg-[#FF3811]">Get More Info</button>
                </div>
            </div>
        </div>
    );
